...
//    static int test = 0;
    ...
    public static void main(String[] args) {
        String[] boards = {
                ...
                "1 6 4 15|5 10 _ 13|9 11 3 7|12 8 2 14", // US
                "1 9 _ 12 10 5 6|8 11 2 3 4 13 7",
                "1 2 3 12 5 6|7 8 9 4 11 17|13 14 15 _ 10 16", // US
                "29 7 14 9 11 16|23 17 24 22 18 20|5 3 21 13 27 15|6 4 12 1 19 28|26 10 8 25 2 _", // US
...
//        String[] boards = {"1 6 4 15|5 10 _ 13|9 11 3 7|12 8 2 14"};
    ...
    private static boolean searchOnceSync(String boardString) {
        System.out.println(boardString);

        Search search = new Search();
        List<Action> actions = search.search(boardString);
